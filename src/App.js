...
function App() {
  ...
  const phoneItems = [
    ...
    {id: 3, title: 'گوشی SAMSUNG A51', srcImage: '/image/mobile item/mobile-item-3.png', price: '25.000.000', rate: 4.2},
    {id: 4, title: 'گوشی SAMSUNG A12 5G', srcImage: '/image/mobile item/mobile-item-4.png', price: '15.000.000', rate: 3.6},
    {id: 5, title: 'گوشی IPhone12 CH 128GB', srcImage: '/image/mobile item/mobile-item-5.png', price: '50.000.000', rate: 4.7},
    {id: 6, title: 'گوشی SAMSUNG A16 5G', srcImage: '/image/mobile item/mobile-item-6.png', price: '16.000.000', rate: 3},
    {id: 7, title: 'گوشی SAMSUNG A14', srcImage: '/image/mobile item/mobile-item-7.png', price: '12.000.000', rate: 2.7},
    {id: 8, title: 'گوشی Redmi 256GB', srcImage: '/image/mobile item/mobile-item-8.png', price: '22.000.000', rate: 3.8},
    {id: 9, title: 'گوشی Poco 512GB', srcImage: '/image/mobile item/mobile-item-9.png', price: '24.000.000', rate: 4.3},
    {id: 10, title: 'گوشی Redmi 512GB', srcImage: '/image/mobile item/mobile-item-10.png', price: '27.000.000', rate: 4.6},
    {id: 11, title: 'گوشی SAMSUNG A71', srcImage: '/image/mobile item/mobile-item-11.png', price: '32.000.000', rate: 4.5},
    {id: 12, title: 'گوشی Redmi 12', srcImage: '/image/mobile item/mobile-item-12.png', price: '17.000.000', rate: 4},
  ]
